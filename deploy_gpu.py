...
from model_training import Resnet_Network3
from model_training import MaxPooling_CNN
from model_training import ResidualBlock
...
if __name__ == "__main__":
    ...
    uvicorn.run(app, host="113.54.236.229", port=8000)
